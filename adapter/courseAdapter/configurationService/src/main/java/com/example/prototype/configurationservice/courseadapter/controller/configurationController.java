package com.example.prototype.configurationservice.courseadapter.controller;
...
import com.example.prototype.configurationservice.courseadapter.service.ConfigurationService;
...
public class configurationController {
    ...
    public ResponseEntity<ConfigurationModel> updateConfig(@PathVariable int courseId, @RequestBody CourseConfiguration configuration) {
        configurationService.updateConfiguration(courseId, configuration);
        return ResponseEntity.ok(configurationService.getConfiguration(courseId));
    }

    // REST PUT
    // link another adapter with course timeline adapter
    ...
    // REST PUT
    // unlink another adapter from course timeline adapter
